...
/**
 * Adds connections between given class node and other class nodes in a diagram.
 */
public class ConnectSingleClassCommand extends AbstractConnectCommand
{
  private String qualifiedClassName;

  public ConnectSingleClassCommand (@NotNull String qualifiedClassName)
  {
  ...
  public void execute (@NotNull UMLDiagram diagram)
  {
    ...
    if (psiClass != null)
    {
      ...
      if (subjectNode != null)
      {
        addEdges (diagram, subjectNode, usingClasses,     false);
        addEdges (diagram, subjectNode, usedClasses,      true);
        addEdges (diagram, subjectNode, extendingClasses, false);
        addEdges (diagram, subjectNode, extendedClasses,  true);
      }
    }
  }
  ...
  {
    return "connect contained classes to " + qualifiedClassName + " by any dependency";
  }
}