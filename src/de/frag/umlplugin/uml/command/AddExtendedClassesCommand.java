 ...
 */
public class AddExtendedClassesCommand extends AbstractAddDependentClassesCommand
{
  public AddExtendedClassesCommand (@NotNull String qualifiedClassName)
  {
  ...
  {
    return "add classes that are extended by " + qualifiedClassName;
  }
}