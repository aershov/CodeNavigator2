...
/**
 * Adds connections between given class node and other class nodes in a diagram that use given class.
 */
public class ConnectSingleClassUsingCommand extends AbstractConnectCommand
{
  private String qualifiedClassName;

  public ConnectSingleClassUsingCommand (String qualifiedClassName)
  {
  ...
  {
    return "connect contained classes that are using " + qualifiedClassName;
  }
}