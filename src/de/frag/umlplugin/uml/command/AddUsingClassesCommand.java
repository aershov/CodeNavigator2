 ...
 */
public class AddUsingClassesCommand extends AbstractAddDependentClassesCommand
{
  public AddUsingClassesCommand (@NotNull String qualifiedClassName)
  {
  ...
  {
    return "add classes that use " + qualifiedClassName;
  }
}