...
/**
 * Removes all "create" edges from a diagram.
 */
public class RemoveAllCreateEdgesCommand extends AbstractDiagramCommand
{
  public void execute (@NotNull UMLDiagram diagram)
  {
    for (Edge edge : diagram.getEdges ())
    {
      ...
      if (usageType == UsageType.NEW_EXPRESSION)
      {
  ...
  {
    return "remove all 'create'-edges from diagram";
  }
}