...
/**
 * Adds connections between given class node and other class nodes in a diagram that are used by given class.
 */
public class ConnectSingleClassUsedCommand extends AbstractConnectCommand
{
  private String qualifiedClassName;

  public ConnectSingleClassUsedCommand (String qualifiedClassName)
  {
  ...
  {
    return "connect contained classes that are used by " + qualifiedClassName;
  }
}