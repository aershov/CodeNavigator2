...
import de.frag.umlplugin.uml.command.AddUsedClassesCommand;
 ...
 */
public class AddUsedClassesAction extends AbstractClassNodeAction
{
  /**
  ...
  protected @Nullable DiagramCommand createCommand (@NotNull Node node)
  {
    ...
    if (psiClass != null)
    {
      ...
      {
        return new AddUsedClassesCommand (qualifiedClassName);
      }
    }
    return null;
  }
