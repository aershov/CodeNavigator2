...
import de.frag.umlplugin.uml.command.ConnectClassesExtendedCommand;
import de.frag.umlplugin.uml.command.DiagramCommand;

/**
 * Connects all classes in diagram that extend each other.
 */
public class ConnectClassesExtendedAction extends AnAction
{
  /**
   * Connects all classes in diagram that extend each other.
  ...
  public void actionPerformed (AnActionEvent e)
  {
    ...
    if (diagrams != null)
    {
      ...
      if (umlDiagram != null)
      {
        DiagramCommand command = new ConnectClassesExtendedCommand ();
