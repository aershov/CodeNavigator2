...
import de.frag.umlplugin.uml.command.AddExtendingClassesCommand;
 ...
 */
public class AddExtendingClassesAction extends AbstractClassNodeAction
{
  /**
  ...
  protected @Nullable DiagramCommand createCommand (@NotNull Node node)
  {
    ...
    if (psiClass != null)
    {
      ...
      {
        return new AddExtendingClassesCommand (qualifiedClassName);
      }
    }
    return null;
  }
